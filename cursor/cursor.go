...
// Esc is the ANSI escape code prefix
const Esc = "\x1b"
...
// MoveToHorizontal returns ANSI escape sequence to move
// cursor the the specified position on the current line.
func MoveToHorizontal(col int) string {
	return escape("[%dG", col)
}
